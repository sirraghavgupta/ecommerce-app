...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/customer/product/*").permitAll()
                .antMatchers("/customer/products/*").permitAll()
                .antMatchers("/customer/similar-products/*").permitAll()
                ...
                .antMatchers("/categories/customer").permitAll()
