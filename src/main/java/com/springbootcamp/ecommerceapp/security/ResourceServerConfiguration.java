...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/seller/product/{id}").hasAnyRole("SELLER","ADMIN")
                .antMatchers("/seller/product-variations").hasAnyRole("SELLER", "ADMIN")
                .antMatchers("/seller/product-variation/{id}").hasAnyRole("SELLER", "ADMIN")
                .antMatchers("/seller/product-variations/{productId}").hasAnyRole("SELLER", "ADMIN")
